...
class Frame:
    ...
    def lookup(self, symbol):
        ...
        while (cur_frame != None):
            tmp = cur_frame.bindings.get(symbol)
            if (tmp != None):
                return tmp
    ...
    def make_child_frame(self, formals, vals):
        ...
        # BEGIN PROBLEM 8
        cur_formals, cur_vals = formals, vals
        while (cur_formals != nil and cur_vals != nil):
            new_frame.define(cur_formals.first, cur_vals.first)
            cur_formals, cur_vals = cur_formals.rest, cur_vals.rest
