...
class BPlusTree {
 ...
 public:
  ...
  auto InsertInLeaf(BPlusTreePage *page, const KeyType &key, const ValueType &value, Transaction *txn) -> bool;
  auto InsertInInternal(BPlusTreePage *page, page_id_t l, const KeyType &key, page_id_t r) -> bool;
  void InsertInParent(Context *ctx, page_id_t l, const KeyType &key, page_id_t r);

  // Remove a key and its value from this B+ tree.
  void RemoveEntry(Context *ctx, BPlusTreePage *cur, const KeyType &key);
  auto RemoveKV(Context *ctx, BPlusTreePage *page, const KeyType &key) -> bool;
  void Merge(Context *ctx, BPlusTreePage *l, BPlusTreePage *r, const KeyType &key);
  void BorrowFromLeft(Context *ctx, BPlusTreePage *parent, BPlusTreePage *dst, BPlusTreePage *src,
                      const KeyType &key_parent, int idx);
  void BorrowFromRight(Context *ctx, BPlusTreePage *parent, BPlusTreePage *dst, BPlusTreePage *src,
                       const KeyType &key_parent, int idx);
